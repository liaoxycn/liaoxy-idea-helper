 ...
 */
package com.github.liaoxiangyun.ideaplugin.commit.vcs
...
class AliCodeAnalysisCheckinHandler(
    ...
    override fun getBeforeCheckinConfigurationPanel(): RefreshableOnComponent? {
        val checkBox = NonFocusableCheckBox("校验Commit格式")
    ...
    private fun getSettings(): AppSettingsState {
    ...
    override fun beforeCheckin(
        ...
        val parse = CommitMessage.parse(myCheckinPanel.commitMessage)
        val verify = parse.getVerify()
